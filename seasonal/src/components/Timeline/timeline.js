...
function Timeline({ cssSeason }) {
  return (
    <div className={css.timeline}>
      ...
      <div>
        <VerticalTimeline
          className={css.verticalTimeline}
        ...
        >
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                Apple, Beetroot, Brussels Sprouts, Cauliflower, Celeriac,
                Celery, Chicory, Horseradish, Jerusalem Artichoke, Kale,
                Kohlrabi, Leeks, Parsnips, Pear, Potatoes, Rhubarb, Salsify,
                Shallots, Swede, Turnips
              </p>
            </div>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            ...
            <p className={css.produce}>
              Brussel Sprouts, Cauliflower, Beetroot, Celeriac, Chicory,
              Jerusalem Artichoke, Kale, Kohlrabi, Leeks, Parsnips, Potatoes,
              Purple Sprouting Broccoli, Rhubarb, Salsify, Shallots, Swede,
              Turnips
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                ...
                Mint, Nasturtium, New Potatoes, Parsley, Oregano, Peas,
                Radishes, Rhubarb, Rocket, Rosemary, Sage, Samphire, Sorrel,
                Spinach, Spring Onions, Tarragon, Watercress, Wild Nettles, Wild
                Garlic
              </p>
            </div>
          </VerticalTimelineElement>
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                ...
                Strawberries, Tarragon, Thyme, Tomatoes, Turnips, Watercress,
                Wild Nettles
              </p>
            </div>
          </VerticalTimelineElement>
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                Artichoke, Aubergine, Basil, Beetroot, Bilberries,
                Blackcurrants, Blueberries, Broad Beans, Broccoli, Carrots,
                Chard, Chervil, Chillies, Cherries, Chives, Coriander,
                Courgettes, Dill, Elderflower, Fennel, French Beans, Garlic,
                Gooseberries, Greengages, Jersey Royal New Potatoes, Kohlrabi,
                Lettuce & Salad Leaves, Mangetout, Mint, Nasturtium, New
                Potatoes, Onions, Oregano, Pak Choi, Parsley, Peas, Radishes,
                Rocket, Rosemary, Runner Beans, Sage, Samphire, Shallots,
                Sorrel, Spinach, Spring Onions, Strawberries, Tarragon, Thyme,
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                ...
                Broad Beans, Broccoli, Carrots, Chard, Cherries, Chillies,
                Chives, Coriander, Courgettes, Cucumber, Damsons, Fennel,
                Greengages, French Beans, Garlic, Kohlrabi, Lettuce,
                Loganberries, Mangetout, Marrow, Mint, Onions, Oregano, Pak
                Choi, Parsley, Peas, Peppers, Plums, Potatoes (maincrop),
                Radishes, Raspberries, Redcurrants, Rocket, Rosemary, Runner
                Beans, Sage, Shallots, Sorrel, Spring Onions, Strawberries,
                Sweetcorn, Tarragon, Thyme, Tomatoes, Turnips, Watercress, Wild
                Mushrooms
              </p>
            </div>
          </VerticalTimelineElement>
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                Apples, Artichoke, Aubergine, Beetroot, Bilberries,
                Blackberries, Broccoli, Butternut Squash, Carrots, Celeriac,
                Celery, Chard, Chestnuts, Chillies, Chives, Cob Nuts, Coriander,
                Courgettes, Cucumber, Damsons, Elderberries, Fennel, French
                Beans, Garlic, Horseradish, Kale, Kohlrabi, Leeks, Lettuce &
                Salad Leaves, Mangetout, Marrow, Mint, Onions, Oregano, Pak
                Choi, Parsley, Pears, Peppers, Plums, Potatoes, Pumpkin,
                Radishes, Raspberries, Redcurrants, Rocket, Rosemary, Runner
                Beans, Sage, Shallots, Sorrel, Spring Onions, Sweetcorn, Thyme,
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                ...
                Radishes, Rocket, Rosemary, Runner Beans, Sage, Salsify,
                Shallots, Sorrel, Squashes, Swede, Sweetcorn, Thyme, Tomatoes,
          ...
          >
            <div>
              ...
              <p className={css.produce}>
                Apples, Beetroot, Brussels Sprouts, Cauliflower, Celeriac,
                Celery, Chestnuts, Chicory, Horseradish, Jerusalem Artichoke,
                Kale, kohlrabi, Leeks, Parsnips, Pears, Potatoes, Salsify,
                Shallots, Swede, Turnips, Wild Mushrooms
              </p>
            </div>
          </VerticalTimelineElement>
        </VerticalTimeline>
